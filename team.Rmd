...
Overall, it is clear that average ratings go up and down. This is why creating blocks of 3 years helps reduce the noise. This method allowed us to see how the average stayed relatively the same, but the standard deviation varied greatly, which was very interesting to see. Likewise, the line graph shows how a smoothed average reveals the upwards trend occuring until 2017.